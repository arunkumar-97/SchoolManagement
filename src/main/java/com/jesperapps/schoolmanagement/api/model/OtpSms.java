...
public class OtpSms {
	...
	public OtpSms(Long phoneNumber, int otp, Integer expireMins, String otpGenerationTime) {
	...
	public String toString() {
		return "OtpSms [otpSmsId=" + otpSmsId + ", phoneNumber=" + phoneNumber + ", otp=" + otp + ", expireMins="
				+ expireMins + ", otpGenerationTime=" + otpGenerationTime + "]";
	}
